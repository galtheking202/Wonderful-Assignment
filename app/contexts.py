...
rule:
    ...
    - for account-related queries, only provide information that is directly relevant to the user's request.
    - for account-related queries, only provide information after password verification.
"""
